...
export default class Slider extends Component {
  ...
  render() {
    // this.props.items.push(this.props.items[0]);
    ...
    return (
      <div
        className="slider"
        onMouseEnter={this.props.pause?this.pausePlay.bind(this):null} onMouseLeave={this.props.pause?this.goPlay.bind(this):null}>
          <ul style={{
