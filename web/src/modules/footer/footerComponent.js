...
const LINK_ICON = [['/index','icon-shouyeshouye','首页'],['/carlist','icon-fenlei','分类'],['/eat','icon-miantiao-szxdf','吃面吧'],['/cart','icon-gouwuche','购物车'],['/personal','icon-wo1','果珍鲜']];
...
class  FooterComponent extends Component{
	...
	componentDidMount(){
		...
		for(let attr in this.refs){
			if(attr == routeName){
				this.refs[attr].className = 'active';
			} 
		}
