...
var City = React.createClass({
    ...
    //     this.refs.sheng.value = addresssheng
    //     this.refs.city.value = addressusercity;
    //     this.refs.county.value = addressuserqu;
        ...
        return (
                <div>
                    <li className="addressMsgNowLi">
                        <select name={this.props.provinceName ? this.props.provinceName : "province"} style={this.style} onChange={this.provinceChange} ref = "sheng" className="sheng">
                            <option key="-1" value="-1" data-index="-1">省份</option>
                            {this.provinceOption()}
                        </select>
                    </li>
                    <li className="addressMsgNowLi">
                        <select name={this.props.cityName ? this.props.cityName : "city"} style={this.style} onChange={this.cityChange} ref="city" className="usercity">
